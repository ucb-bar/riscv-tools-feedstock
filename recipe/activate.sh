...
# different argument #1 to _ucbbarriscvtools_activation
# 2. it doesn't support programs or tc_prefix in it's argument list
# 3. names activation function _ucbbarriscvtools_activation because it's different than _tc_activation
